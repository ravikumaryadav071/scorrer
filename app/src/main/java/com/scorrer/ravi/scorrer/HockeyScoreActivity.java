...
public class HockeyScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TeamsDataEntry(this, "HOCKEY", mainUIHandler);
    ...
    private void finishInitializing(String matchId){
        ...
        if(tabs!=null){
            tabs.setAdapter(new HockeyTabAdapter(getSupportFragmentManager()));
