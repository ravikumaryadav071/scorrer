...
public class HockeyTeamFragment extends Fragment {
    ...
    public HockeyTeamFragment() {

    }

    public static HockeyTeamFragment newInstance(int page, String data, Button next) {
        ...
        HockeyTeamFragment fragment = new HockeyTeamFragment();
        ...
        switch (page_no){
                ...
                teamName.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        if(!s.toString().equals("")) {
                            ...
                            ArrayList<HashMap<String, String>> results = dbHandler.runQuery("SELECT * FROM teams WHERE game_type=\'HOCKEY\' AND team_name LIKE \'%" + s.toString() + "%\' ", "SELECT");
                            int tot = 0;
                            if (results != null) {
                                tot = results.size();
                            }
            ...
            case 3:
                ...
                OteamName.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        dbHandler.setTable_name("teams");
                        ArrayList<HashMap<String, String>> results = dbHandler.runQuery("SELECT * FROM teams WHERE game_type=\'HOCKEY\' AND team_name != \'"+team1_name+"\' AND team_name LIKE \'%"+s.toString()+"%\' ", "SELECT");
                        int tot = 0;
                        if(results!=null){
                            tot = results.size();
                            Oadapter.clear();
